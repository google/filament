...
<a href="#materialmodels"  target="_self" class="level1"><span class="tocNumber">3&nbsp; </span>Material models</a><br/>
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="#materialmodels/clothmodel/subsurfacecolor"  target="_self" class="level3"><span class="tocNumber">3.3.2&nbsp; </span>Subsurface color</a><br/>
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="#materialdefinitions/fragmentblock/materialfragmentinputs"  target="_self" class="level3"><span class="tocNumber">4.4.2&nbsp; </span>Material fragment inputs</a><br/>
...
<dl><dt>Metals (conductors)</dt><dd><p>  Defines the specular color of the surface. Real-world values are typically found in the range
...
<center><div class="image" style=""><a class="target" name="figure_materialsheencolor">&nbsp;</a><a href="../images/screenshot_sheen_color.png" target="_blank"><img class="markdeep" src="../images/screenshot_sheen_color.png" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;7:</b> Different sheen colors</span></center></div></center>
</p><p>
...
<center><div class="image" style=""><a class="target" name="figure_anisotropydirectionproperty">&nbsp;</a><a href="../images/screenshot_anisotropy.png" target="_blank"><img class="markdeep" src="../images/screenshot_anisotropy.png" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;15:</b> Anisotropic metal rendered
</span></center></div></center>
</p><p>
...
<center><div class="image" style=""><a class="target" name="figure_anisotropydirectionproperty">&nbsp;</a><a href="../images/screenshot_anisotropy_map.jpg" target="_blank"><img class="markdeep" src="../images/screenshot_anisotropy_map.jpg" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;16:</b> Example of Lighting: specularAmbientOcclusiona direction map</span></center></div></center>
</p>
...
<center><div class="image" style=""><a class="target" name="figure_aoexample">&nbsp;</a><a href="../images/screenshot_ao.jpg" target="_blank"><img class="markdeep" src="../images/screenshot_ao.jpg" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;17:</b> Comparison of materials without diffuse ambient occlusion
</span></center></div></center>
</p>
...
<a href="#table_commonmatior" target="_self">Table&nbsp;6</a> describes acceptable refractive indices for various types of materials.
<div class='table'>
...
<center><div class="image" style=""><a class="target" name="figure_iorproperty">&nbsp;</a><a href="../images/material_ior.png" target="_blank"><img class="markdeep" src="../images/material_ior.png" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;22:</b> <code>ior</code> of 1.0 (left) and 1.33 (right)</span></center></div></center>
</p><p>
...
<center><div class="image" style=""><a class="target" name="figure_transmissionproperty">&nbsp;</a><a href="../images/materials/transmission.png" target="_blank"><img class="markdeep" src="../images/materials/transmission.png" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;23:</b> <code>transmission</code> varying from 0.0
</span></center></div></center>
</p><p>
...
<center><div class="image" style=""><a class="target" name="figure_materialvelvet">&nbsp;</a><a href="../images/screenshot_cloth_velvet.png" target="_blank"><img class="markdeep" src="../images/screenshot_cloth_velvet.png" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;29:</b> Velvet fabric showcasing forward and
</span></center></div></center>
</p><p>
...
<div class="admonition tip">To see the effect of the <code>roughness</code> parameter make sure the <code>sheenColor</code> is brighter than
...
<div class="admonition tip">The <code>subsurfaceColor</code> parameter should be used with care. High values can interfere with shadows
...
The effect of <code>sheenColor</code> is shown in <a href="#figure_materialclothsheen" target="_self">figure&nbsp;30</a>
(click on the image to see a larger version).
</p><p>
...
<div class="admonition warning">The cloth material model is more expensive to compute when the <code>subsurfaceColor</code> property is used.</div>
</p><p>
The effect of <code>subsurfaceColor</code> is shown in <a href="#figure_materialclothsubsurface" target="_self">figure&nbsp;31</a>
(click on the image to see a larger version).
</p><p>
...
in <a href="#table_unlitproperties" target="_self">table&nbsp;9</a>.
<div class='table'>
<a class="target" name="table_unlitproperties">&nbsp;</a><table class="table"><tr><th  style="text-align:right"> Property </th><th  style="text-align:left"> Definition </th></tr>
...
The type and range of each property is described in <a href="#table_unlitpropertiestypes" target="_self">table&nbsp;10</a>.
<div class='table'>
...
<a href="#figure_materialunlit" target="_self">Figure&nbsp;32</a> shows an example of the unlit material model
(click on the image to see a larger version).
</p><p>
<center><div class="image" style=""><a class="target" name="figure_materialunlit">&nbsp;</a><a href="../images/screenshot_unlit.jpg" target="_blank"><img class="markdeep" src="../images/screenshot_unlit.jpg" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;32:</b> The unlit model is used to render debug information</span></center></div></center>
</p>
...
<div class='table'>
<a class="target" name="table_glossinessproperties">&nbsp;</a><table class="table"><tr><th  style="text-align:right"> Parameter </th><th  style="text-align:left"> Definition </th></tr>
<tr><td  style="text-align:right"> <strong class="asterisk">baseColor</strong> </td><td  style="text-align:left"> Surface diffuse color </td></tr>
...
The type and range of each property is described in <a href="#table_glossinesspropertiestypes" target="_self">table&nbsp;12</a>.
<div class='table'>
...
the <em class="underscore">lit</em> material model (see <a href="#litmodel" target="_self">Lit model</a> section), uses the default opaque blending mode, requires
...
<dl><table><tr valign=top><td><dt>Type</dt></td><td><dd><p>     <code>number</code>
...
<a class="target" name="table_featurelevels">&nbsp;</a><table class="table"><tr><th  style="text-align:left"> Feature Level </th><th  style="text-align:left"> Guaranteed features </th></tr>
...
<dl><dt>Description</dt><dd><p>      Sets the feature level of the material. Each feature level defines a set of features the
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre><p>
<dl><table><tr valign=top><td><dt>Bugs</dt></td><td><dd><p>      <code>matc</code> doesn't verify that a material is not using features above its selected feature level.
...
</p></dd></td></tr><tr valign=top><td><dt>Description</dt></td><td><dd><p>      Selects the material model as described in the <a href="#materialmodels" target="_self">Material models</a> section.
</p></dd></td></tr></table></dl></p><pre class="listing tilde"><code><span class="line"></span>material <span class="hljs-punctuation">{</span>
...
<tr><td  style="text-align:left"> float3&times;3 </td><td  style="text-align:left"> Matrix of 3&times;3 floats </td></tr>
<tr><td  style="text-align:left"> float4&times;4 </td><td  style="text-align:left"> Matrix of 4&times;4 floats </td></tr>
...
<dl><dt>Samplers</dt><dd><p>      Sampler types can also specify a <code>format</code> which can be either <code>int</code> or <code>float</code> (defaults to
      <code>float</code>).
...
<span class="line"></span>    <span class="hljs-punctuation">}</span>
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="general:constants">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/general:constants">&nbsp;</a><a class="target" name="toc4.2.5">&nbsp;</a><h3>General: constants</h3>
<p>

<dl><dt>Type</dt><dd><p>    array of constant objects
</p></dd><dt>Value</dt><dd><p>    Each entry is an object with the properties <code>name</code> and <code>type</code>, both of <code>string</code> type. The name
    must be a valid GLSL identifier. Entries also have an optional <code>default</code>, which can either be a
    <code>bool</code> or <code>number</code>, depending on the <code>type</code> of the constant. The type must be one of the types
    described in <a href="#table_materialconstantstypes" target="_self">table&nbsp;15</a>.
</p></dd></dl><div class='table'>
...
<dl><dt>Description</dt><dd><p>    Lists the constant parameters accepted by your material. These constants can be set, or
    &ldquo;specialized&rdquo;, at runtime when loading a material package. Multiple materials can be loaded from
    ...
    constant parameters from the shader by prefixing the name with <code>materialConstant_</code>. For example,
    a constant parameter named <code>myConstant</code> is accessed in the shader as
    <code>materialConstant_myConstant</code>. If a constant parameter is not set at runtime, the default is
    used.
</p></dd></dl></p><pre class="listing tilde"><code><span class="line"></span>material <span class="hljs-punctuation">{</span>
...
<span class="line"></span>    <span class="hljs-punctuation">}</span>
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="general:variantfilter">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/general:variantfilter">&nbsp;</a><a class="target" name="toc4.2.6">&nbsp;</a><h3>General: variantFilter</h3>
<p>

<dl><dt>Type</dt><dd><p>     array of <code>string</code>
</p></dd><dt>Value</dt><dd><p>      Each entry must be any of <code>dynamicLighting</code>, <code>directionalLighting</code>, <code>shadowReceiver</code>,
      <code>skinning</code>, <code>ssr</code>, or <code>stereo</code>.
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="general:flipuv">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/general:flipuv">&nbsp;</a><a class="target" name="toc4.2.7">&nbsp;</a><h3>General: flipUV</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="general:quality">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/general:quality">&nbsp;</a><a class="target" name="toc4.2.8">&nbsp;</a><h3>General: quality</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="general:instanced">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/general:instanced">&nbsp;</a><a class="target" name="toc4.2.9">&nbsp;</a><h3>General: instanced</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="general:vertexdomaindevicejittered">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/general:vertexdomaindevicejittered">&nbsp;</a><a class="target" name="toc4.2.10">&nbsp;</a><h3>General: vertexDomainDeviceJittered</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="vertexandattributes:requires">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/vertexandattributes:requires">&nbsp;</a><a class="target" name="toc4.2.11">&nbsp;</a><h3>Vertex and attributes: requires</h3>
<p>
...
<span class="line"></span>    <span class="hljs-punctuation">}</span>
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="vertexandattributes:variables">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/vertexandattributes:variables">&nbsp;</a><a class="target" name="toc4.2.12">&nbsp;</a><h3>Vertex and attributes: variables</h3>
<p>
...
<span class="line"></span>    <span class="hljs-punctuation">}</span>
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="vertexandattributes:vertexdomain">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/vertexandattributes:vertexdomain">&nbsp;</a><a class="target" name="toc4.2.13">&nbsp;</a><h3>Vertex and attributes: vertexDomain</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="vertexandattributes:interpolation">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/vertexandattributes:interpolation">&nbsp;</a><a class="target" name="toc4.2.14">&nbsp;</a><h3>Vertex and attributes: interpolation</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="blendingandtransparency:blending">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/blendingandtransparency:blending">&nbsp;</a><a class="target" name="toc4.2.15">&nbsp;</a><h3>Blending and transparency: blending</h3>
<p>
...
</p></dd></dl><div class="admonition note">When <code>blending</code> is set to <code>masked</code>, alpha to coverage is automatically enabled for the material.
    If this behavior is undesirable, refer to the <a href="#rasterization:alphatocoverage" target="_self">Rasterization: alphaToCoverage</a> section to turn
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="blendingandtransparency:blendfunction">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/blendingandtransparency:blendfunction">&nbsp;</a><a class="target" name="toc4.2.16">&nbsp;</a><h3>Blending and transparency: blendFunction</h3>
<p>
...
</p></dd><dt>Description</dt><dd><p>        - <em class="asterisk">srcRGB</em>: source function applied to the RGB channels
        - <em class="asterisk">srcA</em>: source function applied to the alpha channel
        - <em class="asterisk">srcRGB</em>: destination function applied to the RGB channels
        - <em class="asterisk">srcRGB</em>: destination function applied to the alpha channel
        The values possible for each functions are one of <code>zero</code>, <code>one</code>, <code>srcColor</code>, <code>oneMinusSrcColor</code>,
               <code>dstColor</code>, <code>oneMinusDstColor</code>, <code>srcAlpha</code>, <code>oneMinusSrcAlpha</code>, <code>dstAlpha</code>,
               <code>oneMinusDstAlpha</code>, <code>srcAlphaSaturate</code>
</p></dd></dl></p><pre class="listing tilde"><code><span class="line"></span>material <span class="hljs-punctuation">{</span>
...
<span class="line"></span>    <span class="hljs-punctuation">}</span>
<span class="line"></span> <span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="blendingandtransparency:postlightingblending">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/blendingandtransparency:postlightingblending">&nbsp;</a><a class="target" name="toc4.2.17">&nbsp;</a><h3>Blending and transparency: postLightingBlending</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="blendingandtransparency:transparency">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/blendingandtransparency:transparency">&nbsp;</a><a class="target" name="toc4.2.18">&nbsp;</a><h3>Blending and transparency: transparency</h3>
<p>
...
<ul>
<li class="minus"><code>default</code>: the transparent object is rendered normally (as seen in <a href="#figure_transparencydefault" target="_self">figure&nbsp;33</a>),
...
<li class="minus"><code>twoPassesOneSide</code>: the transparent object is first rendered in the depth buffer, then again in
  ...
  transparent object as shown in <a href="#figure_transparencytwopassesoneside" target="_self">figure&nbsp;34</a>.
</li>
<li class="minus"><code>twoPassesTwoSides</code>: the transparent object is rendered twice in the color buffer: first with its
  ...
  or eliminating sorting issues, as shown in <a href="#figure_transparencytwopassestwosides" target="_self">figure&nbsp;35</a>.
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre><p>
<center><div class="image" style=""><a class="target" name="figure_transparencydefault">&nbsp;</a><a href="../images/screenshot_transparency_default.png" target="_blank"><img class="markdeep" src="../images/screenshot_transparency_default.png" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;33:</b> This double sided model shows the type of sorting issues transparent
</span></center></div></center>
</p><p>
<center><div class="image" style=""><a class="target" name="figure_transparencytwopassesoneside">&nbsp;</a><a href="../images/screenshot_twopasses_oneside.png" target="_blank"><img class="markdeep" src="../images/screenshot_twopasses_oneside.png" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;34:</b> In <code>twoPassesOneSide</code> mode, only one set of faces is visible
</span></center></div></center>
</p><p>
...
<a class="target" name="blendingandtransparency:maskthreshold">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/blendingandtransparency:maskthreshold">&nbsp;</a><a class="target" name="toc4.2.19">&nbsp;</a><h3>Blending and transparency: maskThreshold</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="blendingandtransparency:refractionmode">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/blendingandtransparency:refractionmode">&nbsp;</a><a class="target" name="toc4.2.20">&nbsp;</a><h3>Blending and transparency: refractionMode</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="blendingandtransparency:refractiontype">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/blendingandtransparency:refractiontype">&nbsp;</a><a class="target" name="toc4.2.21">&nbsp;</a><h3>Blending and transparency: refractionType</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="rasterization:culling">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/rasterization:culling">&nbsp;</a><a class="target" name="toc4.2.22">&nbsp;</a><h3>Rasterization: culling</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="rasterization:colorwrite">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/rasterization:colorwrite">&nbsp;</a><a class="target" name="toc4.2.23">&nbsp;</a><h3>Rasterization: colorWrite</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="rasterization:depthwrite">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/rasterization:depthwrite">&nbsp;</a><a class="target" name="toc4.2.24">&nbsp;</a><h3>Rasterization: depthWrite</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="rasterization:depthculling">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/rasterization:depthculling">&nbsp;</a><a class="target" name="toc4.2.25">&nbsp;</a><h3>Rasterization: depthCulling</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="rasterization:doublesided">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/rasterization:doublesided">&nbsp;</a><a class="target" name="toc4.2.26">&nbsp;</a><h3>Rasterization: doubleSided</h3>
<p>
...
<span class="line"></span>    <span class="hljs-punctuation">}</span>
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="rasterization:alphatocoverage">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/rasterization:alphatocoverage">&nbsp;</a><a class="target" name="toc4.2.27">&nbsp;</a><h3>Rasterization: alphaToCoverage</h3>
<p>
...
<span class="line"></span>    <span class="hljs-punctuation">}</span>
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="lighting:reflections">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/lighting:reflections">&nbsp;</a><a class="target" name="toc4.2.28">&nbsp;</a><h3>Lighting: reflections</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="lighting:shadowmultiplier">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/lighting:shadowmultiplier">&nbsp;</a><a class="target" name="toc4.2.29">&nbsp;</a><h3>Lighting: shadowMultiplier</h3>
<p>
...
<span class="line"></span>    <span class="hljs-punctuation">}</span>
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="lighting:transparentshadow">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/lighting:transparentshadow">&nbsp;</a><a class="target" name="toc4.2.30">&nbsp;</a><h3>Lighting: transparentShadow</h3>
<p>
...
<a class="target" name="lighting:clearcoatiorchange">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/lighting:clearcoatiorchange">&nbsp;</a><a class="target" name="toc4.2.31">&nbsp;</a><h3>Lighting: clearCoatIorChange</h3>
<p>
...
<dl><dt>Type</dt><dd><p>     <code>boolean</code>
     ...
     effect is disabled, <code>baseColor</code> is left unmodified. See <a href="#figure_clearcoatiorchange" target="_self">figure&nbsp;37</a> for an
...
<a class="target" name="lighting:multibounceambientocclusion">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/lighting:multibounceambientocclusion">&nbsp;</a><a class="target" name="toc4.2.32">&nbsp;</a><h3>Lighting: multiBounceAmbientOcclusion</h3>
<p>
...
<dl><dt>Type</dt><dd><p>     <code>boolean</code>
     ...
     <a href="#figure_multibounceao" target="_self">Figure&nbsp;38</a> compares the ambient occlusion term of a surface with and without
     multi-bounce ambient occlusion. Notice how multi-bounce ambient occlusion introduces color
     in the occluded areas. <a href="#figure_multibounceaoanimated" target="_self">Figure&nbsp;39</a> toggles between multi-bounce ambient
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre><p>
<center><div class="image" style=""><a class="target" name="figure_multibounceao">&nbsp;</a><a href="../images/screenshot_multi_bounce_ao.jpg" target="_blank"><img class="markdeep" src="../images/screenshot_multi_bounce_ao.jpg" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;38:</b> Brick texture amient occlusion map rendered with multi-bounce ambient
</span></center></div></center>
</p><p>
...
<a class="target" name="lighting:specularambientocclusion">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/lighting:specularambientocclusion">&nbsp;</a><a class="target" name="toc4.2.33">&nbsp;</a><h3>Lighting: specularAmbientOcclusion</h3>
<p>
...
<dl><dt>Type</dt><dd><p>     <code>string</code>
     ...
     This effect helps remove unwanted specular reflections as shown in <a href="#figure_specularao" target="_self">figure&nbsp;40</a>.
...
<a class="target" name="anti-aliasing:specularantialiasing">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/anti-aliasing:specularantialiasing">&nbsp;</a><a class="target" name="toc4.2.34">&nbsp;</a><h3>Anti-aliasing: specularAntiAliasing</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="anti-aliasing:specularantialiasingvariance">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/anti-aliasing:specularantialiasingvariance">&nbsp;</a><a class="target" name="toc4.2.35">&nbsp;</a><h3>Anti-aliasing: specularAntiAliasingVariance</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="anti-aliasing:specularantialiasingthreshold">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/anti-aliasing:specularantialiasingthreshold">&nbsp;</a><a class="target" name="toc4.2.36">&nbsp;</a><h3>Anti-aliasing: specularAntiAliasingThreshold</h3>
<p>
...
<span class="line"></span><span class="hljs-punctuation">}</span></code></pre>
<a class="target" name="shading:customsurfaceshading">&nbsp;</a><a class="target" name="materialdefinitions/materialblock/shading:customsurfaceshading">&nbsp;</a><a class="target" name="toc4.2.37">&nbsp;</a><h3>Shading: customSurfaceShading</h3>
<p>
...
<dl><dt>Type</dt><dd><p>     <code>bool</code>
     ...
     may influence the current fragment. Please refer to the <a href="#customsurfaceshading" target="_self">Custom surface shading</a> section below
     for more information.
</p></dd></dl></p><pre class="listing tilde"><code><span class="line"></span>material <span class="hljs-punctuation">{</span>
...
definition of the structure can be found in the <a href="#materialvertexinputs" target="_self">Material vertex inputs</a> section.
</p><p>
...
APIs listed in the <a href="#shaderpublicapis" target="_self">Shader public APIs</a> section.
</p>
...
<div class="admonition tip"><div class="admonition-title"> worldPosition</div>
</p><p>
    ...
    be able to fit in a <code>float</code> or might be represented with severely reduced precision.</div>
</p><p>
<div class="admonition tip"><div class="admonition-title"> UV attributes</div>
</p><p>
    ...
    this behavior using the <code>flipUV</code> property and setting it to <code>false</code>.</div>
</p>
...
definition of the structure can be found in the <a href="#materialfragmentinputs" target="_self">Material fragment inputs</a> section. The full
definition of the various members of the structure can be found in the <a href="#materialmodels" target="_self">Material models</a> section
of this document.
</p><p>
...
<ul>
<li class="minus"><code>MaterialInputs</code>, as described in the <a href="#materialfragmentinputs" target="_self">Material fragment inputs</a> section and prepared in the
...
<div class="admonition note"><div class="admonition-title"> About shadowed fragments</div>
</p><p>
    ...
    ambient lighting for instance.</div>
</p><p>
<div class="admonition warning"><div class="admonition-title"> Shading models</div>
</p><p>
    Custom surface shading only works with the <code>lit</code> shading model. Attempting to use any other
    model will result in an error.</div>
</p>
...
<span class="line"></span>    }
<span class="line"></span>}</code></pre><p>
The result can be seen in <a href="#figure_toonshading" target="_self">figure&nbsp;41</a>.
</p><p>
<center><div class="image" style=""><a class="target" name="figure_toonshading">&nbsp;</a><a href="../images/screenshot_toon_shading.png" target="_blank"><img class="markdeep" src="../images/screenshot_toon_shading.png" /></a><center><span class="imagecaption"><b style="font-style:normal;">Figure&nbsp;41:</b> simple toon shading implemented with custom
</span></center></div></center>
</p>
...
<div class="admonition tip"><div class="admonition-title"> world space</div>
</p><p>
    To achieve good precision, the &ldquo;world space&rdquo; in Filament's shading system does not necessarily
    match the API-level world space. To obtain the position of the API-level camera, custom
    materials can use <code>getUserWorldFromWorldMatrix()</code> to transform <code>getWorldCameraPosition()</code>.</div>
</p>
<a class="target" name="materialglobals">&nbsp;</a><a class="target" name="materialdefinitions/shaderpublicapis/materialglobals">&nbsp;</a><a class="target" name="toc4.5.5">&nbsp;</a><h3>Material globals</h3>
<p>
<div class='table'><table class="table"><tr><th  style="text-align:left"> Name </th><th  style="text-align:center"> Type </th><th  style="text-align:left"> Description </th></tr>
...
<a class="target" name="vertexonly">&nbsp;</a><a class="target" name="materialdefinitions/shaderpublicapis/vertexonly">&nbsp;</a><a class="target" name="toc4.5.6">&nbsp;</a><h3>Vertex only</h3>
<p>
...
<a class="target" name="fragmentonly">&nbsp;</a><a class="target" name="materialdefinitions/shaderpublicapis/fragmentonly">&nbsp;</a><a class="target" name="toc4.5.7">&nbsp;</a><h3>Fragment only</h3>
<p>
...
<div class="admonition tip"><div class="admonition-title"> world-space</div>
    ...
    never or rarely be used because they may not fit in a float3 or have severely reduced precision.</div>
</p><p>
<div class="admonition tip"><div class="admonition-title"> sampling from render targets</div>
</p><p>
    ...
    coordinate. This will flip the coordinate depending on which backend is being used.</div>
</p>
...
The command line flags relevant to application development are described in <a href="#table_matcflags" target="_self">table&nbsp;16</a>.
<div class='table'>
...
<a class="target" name="--platform">&nbsp;</a><a class="target" name="compilingmaterials/flags/&mdash;platform">&nbsp;</a><a class="target" name="toc5.2.1">&nbsp;</a><h3>&mdash;platform</h3>
<p>
...
<a class="target" name="--api">&nbsp;</a><a class="target" name="compilingmaterials/flags/&mdash;api">&nbsp;</a><a class="target" name="toc5.2.2">&nbsp;</a><h3>&mdash;api</h3>
<p>
...
<a class="target" name="--optimize-size">&nbsp;</a><a class="target" name="compilingmaterials/flags/&mdash;optimize-size">&nbsp;</a><a class="target" name="toc5.2.3">&nbsp;</a><h3>&mdash;optimize-size</h3>
<p>
...
<a class="target" name="--reflect">&nbsp;</a><a class="target" name="compilingmaterials/flags/&mdash;reflect">&nbsp;</a><a class="target" name="toc5.2.4">&nbsp;</a><h3>&mdash;reflect</h3>
<p>
...
<span class="line"></span>  ]
<span class="line"></span>}</code></pre>
<a class="target" name="--variant-filter">&nbsp;</a><a class="target" name="compilingmaterials/flags/&mdash;variant-filter">&nbsp;</a><a class="target" name="toc5.2.5">&nbsp;</a><h3>&mdash;variant-filter</h3>
<p>
...
<a class="target" name="samplerusageinmaterials">&nbsp;</a><a class="target" name="samplerusageinmaterials">&nbsp;</a><a class="target" name="toc7">&nbsp;</a><h1>Sampler usage in Materials</h1>
<p>

The number of usable sampler parameters (e.g.: type is <code>sampler2d</code>) in materials is limited and
depends on the material properties, shading model, feature level and variant filter.
</p>
<a class="target" name="featurelevel1and2">&nbsp;</a><a class="target" name="samplerusageinmaterials/featurelevel1and2">&nbsp;</a><a class="target" name="toc7.1">&nbsp;</a><h2>Feature level 1 and 2</h2>
<p>

<code>unlit</code> materials can use up to 12 samplers by default.
</p><p>
<code>lit</code> materials can use up to 9 samplers by default, however if <code>refractionMode</code> or <code>reflectionMode</code>
is set to <code>screenspace</code> that number is reduced to 8.
</p><p>
Finally if <code>variantFilter</code> contains the <code>fog</code> filter, an extra sampler is made available, such that
<code>unlit</code> materials can use up to 13 and <code>lit</code> materials up to 10 samplers by default.
</p>
<a class="target" name="featurelevel3">&nbsp;</a><a class="target" name="samplerusageinmaterials/featurelevel3">&nbsp;</a><a class="target" name="toc7.2">&nbsp;</a><h2>Feature level 3</h2>
<p>

16 samplers are available.
</p><p>
<div class="admonition tip"><div class="admonition-title"> external samplers</div>
</p><p>
               Be aware that <code>external</code> samplers account for 2 regular samplers.</div>
</p><p>
