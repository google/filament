...
| [onResized](on-resized.md) | [main]<br>abstract fun [onResized](on-resized.md)(width: Int, height: Int)<br>Called when the underlying native window has been resized. |
