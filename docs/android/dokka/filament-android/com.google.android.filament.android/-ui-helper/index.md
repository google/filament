...
| [getDesiredHeight](get-desired-height.md) | [main]<br>open fun [getDesiredHeight](get-desired-height.md)(): Int<br>Returns the requested height for the native surface. |
| [getDesiredWidth](get-desired-width.md) | [main]<br>open fun [getDesiredWidth](get-desired-width.md)(): Int<br>Returns the requested width for the native surface. |
...
| [getSwapChainFlags](get-swap-chain-flags.md) | [main]<br>open fun [getSwapChainFlags](get-swap-chain-flags.md)(): Long<br>Returns the flags to pass to [createSwapChain](../../com.google.android.filament/-engine/create-swap-chain.md) to honor all the options set on this UiHelper. |
| [isMediaOverlay](is-media-overlay.md) | [main]<br>open fun [isMediaOverlay](is-media-overlay.md)(): Boolean<br>Returns true if the SurfaceView used as a render target should be positioned above other surfaces but below the activity's surface. |
| [isOpaque](is-opaque.md) | [main]<br>open fun [isOpaque](is-opaque.md)(): Boolean<br>Returns true if the render target is opaque. |
| [isReadyToRender](is-ready-to-render.md) | [main]<br>open fun [isReadyToRender](is-ready-to-render.md)(): Boolean<br>Checks whether we are ready to render into the attached surface. |
| [setDesiredSize](set-desired-size.md) | [main]<br>open fun [setDesiredSize](set-desired-size.md)(width: Int, height: Int)<br>Set the size of the render target buffers of the native surface. |
| [setMediaOverlay](set-media-overlay.md) | [main]<br>open fun [setMediaOverlay](set-media-overlay.md)(overlay: Boolean)<br>Controls whether the surface of the SurfaceView used as a render target should be positioned above other surfaces but below the activity's surface. |
| [setOpaque](set-opaque.md) | [main]<br>open fun [setOpaque](set-opaque.md)(opaque: Boolean)<br>Controls whether the render target (SurfaceView or TextureView) is opaque or not. |
