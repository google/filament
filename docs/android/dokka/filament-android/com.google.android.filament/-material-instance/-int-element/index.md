...
| [values](values.md) | [main]<br>open fun [values](values.md)(): Array&lt;[MaterialInstance.IntElement](index.md)&gt;<br>Returns an array containing the constants of this enum type, in the order they're declared. This method may be used to iterate over the constants. |
