...
| [feature](feature.md) | [main]<br>open fun [feature](feature.md)(name: [String](https://developer.android.com/reference/kotlin/java/lang/String.html), value: Boolean): [Engine.Builder](index.md)<br>Set a feature flag value. |
...
| [paused](paused.md) | [main]<br>open fun [paused](paused.md)(paused: Boolean): [Engine.Builder](index.md)<br>Sets the initial paused state of the rendering thread. |
| [sharedContext](shared-context.md) | [main]<br>open fun [sharedContext](shared-context.md)(sharedContext: Any): [Engine.Builder](index.md)<br>Sets a sharedContext for the Engine. |
