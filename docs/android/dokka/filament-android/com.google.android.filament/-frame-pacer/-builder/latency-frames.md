//[filament-android](../../../../index.md)/[com.google.android.filament](../../index.md)/[FramePacer](../index.md)/[Builder](index.md)/[latencyFrames](latency-frames.md)
...
| | |
|---|---|
| frames | The latency window in units of 60Hz frames (e.g. 2 frames = 33.3ms). |
