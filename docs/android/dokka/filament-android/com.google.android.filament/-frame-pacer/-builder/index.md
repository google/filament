...
| [latency](latency.md) | [main]<br>open fun [latency](latency.md)(latency: [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-long/index.html)): [FramePacer.Builder](index.md)<br>Sets the required latency window in terms of time duration. |
