...
| [FRONT_AND_BACK](-f-r-o-n-t_-a-n-d_-b-a-c-k/index.md) | [main]<br>[FRONT_AND_BACK](-f-r-o-n-t_-a-n-d_-b-a-c-k/index.md)<br>Front and Back, geometry is not visible |
...
| [values](values.md) | [main]<br>open fun [values](values.md)(): Array&lt;[Material.CullingMode](index.md)&gt;<br>Returns an array containing the constants of this enum type, in the order they're declared. This method may be used to iterate over the constants. |
