...
On platforms which support parallel shader compilation, compilation requests will be processed in order of priority, then insertion order. See Material::compile().

## Entries

| | |
|---|---|
| [CRITICAL](-c-r-i-t-i-c-a-l/index.md) | [main]<br>[CRITICAL](-c-r-i-t-i-c-a-l/index.md)<br>We need this program NOW. |
...
| [values](values.md) | [main]<br>open fun [values](values.md)(): Array&lt;[Material.CompilerPriorityQueue](index.md)&gt;<br>Returns an array containing the constants of this enum type, in the order they're declared. This method may be used to iterate over the constants. |
