...
| Name | Summary |
|---|---|
| [CONFIG_DEFAULT](-c-o-n-f-i-g_-d-e-f-a-u-l-t.md) | [main]<br>val [CONFIG_DEFAULT](-c-o-n-f-i-g_-d-e-f-a-u-l-t.md): Long = 0 |
...
| [CONFIG_READABLE](-c-o-n-f-i-g_-r-e-a-d-a-b-l-e.md) | [main]<br>val [CONFIG_READABLE](-c-o-n-f-i-g_-r-e-a-d-a-b-l-e.md): Long = 2<br>This flag indicates that the `SwapChain` may be used as a source surface for reading back render results. |
...
| [CONFIG_TRANSPARENT](-c-o-n-f-i-g_-t-r-a-n-s-p-a-r-e-n-t.md) | [main]<br>val [CONFIG_TRANSPARENT](-c-o-n-f-i-g_-t-r-a-n-s-p-a-r-e-n-t.md): Long = 1<br>This flag indicates that the `SwapChain` must be allocated with an alpha-channel. |
