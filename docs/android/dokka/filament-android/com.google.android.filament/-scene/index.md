...
| Name | Summary |
|---|---|
| [addEntities](add-entities.md) | [main]<br>open fun [addEntities](add-entities.md)(entities: Array&lt;Int&gt;)<br>Adds a list of entities to the Scene. |
| [addEntity](add-entity.md) | [main]<br>open fun [addEntity](add-entity.md)(entity: Int)<br>Adds an Entity to the Scene. |
...
| [getEntityCount](get-entity-count.md) | [main]<br>open fun [getEntityCount](get-entity-count.md)(): Int<br>Returns the total number of Entities in the Scene, whether alive or not. |
...
| [getLightCount](get-light-count.md) | [main]<br>open fun [getLightCount](get-light-count.md)(): Int<br>Returns the number of active (alive) Light objects in the Scene. |
| [getNativeObject](get-native-object.md) | [main]<br>open fun [getNativeObject](get-native-object.md)(): Long |
| [getRenderableCount](get-renderable-count.md) | [main]<br>open fun [getRenderableCount](get-renderable-count.md)(): Int<br>Returns the number of active (alive) Renderable objects in the Scene. |
...
| [hasEntity](has-entity.md) | [main]<br>open fun [hasEntity](has-entity.md)(entity: Int): Boolean<br>Returns true if the given entity is in the Scene. |
| [remove](remove.md) | [main]<br>open fun [remove](remove.md)(entity: Int)<br>Removes the Renderable from the Scene. |
...
| [removeEntities](remove-entities.md) | [main]<br>open fun [removeEntities](remove-entities.md)(entities: Array&lt;Int&gt;)<br>Removes a list of entities to the Scene. |
...
| [wrap](wrap.md) | [main]<br>open fun [wrap](wrap.md)(nativeObject: Long): [Scene](index.md) |
