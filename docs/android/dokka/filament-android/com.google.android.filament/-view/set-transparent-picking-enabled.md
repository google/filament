...
When transparent picking is enabled, View::pick() will pick from both transparent and opaque renderables. When disabled, View::pick() will only pick from opaque renderables.
