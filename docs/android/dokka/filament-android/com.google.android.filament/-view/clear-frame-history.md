...
When switching Renderer, it may be necessary to clear that history by calling this method. Similarly, if the whole content of the screen change, like when a cut-scene starts, clearing the history might be needed to avoid artifacts due to the previous frame being very different.
