...
32-bits precision is rarely needed, but it does reduce light leaks as well as &quot;fading&quot; of the shadows in some situations. Setting highPrecision to true for a single shadow map will double the memory usage of all shadow maps. This may not be supported on all mobile devices.
