...
This can be used to exclude the skybox, which is desirable if it already contains clouds or fog. The default value is +infinity which applies the fog to everything.
