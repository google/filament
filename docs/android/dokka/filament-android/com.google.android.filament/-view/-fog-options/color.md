...
Color component's values should be between 0 and 1, values above one are allowed but could create a non energy-conservative fog (this is dependant on the IBL's intensity as well).
