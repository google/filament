...
| [create](create.md) | [main]<br>open fun [create](create.md)(): Int<br>Allocates and creates a single new or recycled Entity.<br>[main]<br>open fun [create](create.md)(entities: Array&lt;Int&gt;)<br>Allocates and creates a batch of new or recycled Entities. |
| [destroy](destroy.md) | [main]<br>open fun [destroy](destroy.md)(e: Int)<br>Globally and logically destroys a single Entity identity.<br>[main]<br>open fun [destroy](destroy.md)(entities: Array&lt;Int&gt;)<br>Globally and logically destroys a batch of Entities. |
...
| [getEntityCount](get-entity-count.md) | [main]<br>open fun [getEntityCount](get-entity-count.md)(): Int<br>Returns the total number of currently active/alive Entities. |
| [getIndex](get-index.md) | [main]<br>open fun [getIndex](get-index.md)(e: Int): Int<br>Use carefully, several entities can have the same index. |
| [getLatestEpochID](get-latest-epoch-i-d.md) | [main]<br>open fun [getLatestEpochID](get-latest-epoch-i-d.md)(): Long<br>Returns the current active (unsealed) epoch ID. |
| [getMaxEntityCount](get-max-entity-count.md) | [main]<br>open fun [getMaxEntityCount](get-max-entity-count.md)(): Int<br>Retrieves the maximum theoretical upper bound of entities that can exist concurrently. |
| [getNativeObject](get-native-object.md) | [main]<br>open fun [getNativeObject](get-native-object.md)(): Long |
| [isAlive](is-alive.md) | [main]<br>open fun [isAlive](is-alive.md)(e: Int): Boolean<br>Queries the logical lifecycle state of a given Entity. |
...
| [wrap](wrap.md) | [main]<br>open fun [wrap](wrap.md)(nativeObject: Long): [EntityManager](index.md) |
