...
| [polygonOffsetConstant](polygon-offset-constant.md) | [main]<br>open var [polygonOffsetConstant](polygon-offset-constant.md): [Float](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-float/index.html)<br>Constant bias in depth-resolution units by which shadows are moved away from the light. |
| [polygonOffsetSlope](polygon-offset-slope.md) | [main]<br>open var [polygonOffsetSlope](polygon-offset-slope.md): [Float](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-float/index.html)<br>Bias based on the change in depth in depth-resolution units by which shadows are moved away from the light. |
