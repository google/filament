...
| [falloff](falloff.md) | [main]<br>open fun [falloff](falloff.md)(radius: [Float](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-float/index.html)): [LightManager.Builder](index.md)<br>Set the falloff distance for point lights and spotlights. |
...
| [spotLightCone](spot-light-cone.md) | [main]<br>open fun [spotLightCone](spot-light-cone.md)(inner: [Float](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-float/index.html), outer: [Float](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-float/index.html)): [LightManager.Builder](index.md)<br>Defines a spotlight's angular falloff attenuation. |
