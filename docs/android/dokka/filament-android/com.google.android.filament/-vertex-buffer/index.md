...
| [getVertexCount](get-vertex-count.md) | [main]<br>open fun [getVertexCount](get-vertex-count.md)(): Int<br>Returns the vertex count. |
...
| [setBufferAt](set-buffer-at.md) | [main]<br>open fun [setBufferAt](set-buffer-at.md)(engine: [Engine](../-engine/index.md), bufferIndex: Int, buffer: [Buffer](https://developer.android.com/reference/kotlin/java/nio/Buffer.html))<br>open fun [setBufferAt](set-buffer-at.md)(engine: [Engine](../-engine/index.md), bufferIndex: Int, buffer: [Buffer](https://developer.android.com/reference/kotlin/java/nio/Buffer.html), destOffsetInBytes: Int, count: Int)<br>open fun [setBufferAt](set-buffer-at.md)(engine: [Engine](../-engine/index.md), bufferIndex: Int, buffer: [Buffer](https://developer.android.com/reference/kotlin/java/nio/Buffer.html), destOffsetInBytes: Int, count: Int, handler: Any, callback: [Runnable](https://developer.android.com/reference/kotlin/java/lang/Runnable.html))<br>copy-initializes the specified buffer from the given buffer data. |
| [setBufferObjectAt](set-buffer-object-at.md) | [main]<br>open fun [setBufferObjectAt](set-buffer-object-at.md)(engine: [Engine](../-engine/index.md), bufferIndex: Int, bufferObject: [BufferObject](../-buffer-object/index.md))<br>Swaps in the given buffer object. |
| [wrap](wrap.md) | [main]<br>open fun [wrap](wrap.md)(nativeObject: Long): [VertexBuffer](index.md) |
