...
void evaluateScreenSpaceReflections(const PixelParams pixel, inout vec3 Fr) {
    highp vec3 wsRayDirection = getReflectedVector(pixel, shading_view, shading_normal);
