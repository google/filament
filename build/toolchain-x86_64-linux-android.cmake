...
if (NOT FILAMENT_NDK_VERSION)
    get_filename_component(CMAKE_TOOLCHAIN_PATH "${CMAKE_SOURCE_DIR}/${CMAKE_TOOLCHAIN_FILE}" DIRECTORY)
    file(READ "${CMAKE_TOOLCHAIN_PATH}/android/ndk.version" FILAMENT_NDK_VERSION)
