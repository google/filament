...
func EditTypeScript(definitions []db.TypeDefinition, namespace string, folder string) {
	...
	file.WriteString("\n// ================================================================================================\n")
	file.WriteString("// DO NOT ADD MANUAL DECLARATIONS HERE!\n")
	file.WriteString("//\n")
	file.WriteString("// Everything in this section is generated by beamsplitter and will be OVERWRITTEN on next run.\n")
	file.WriteString("// All manual TypeScript additions must be placed in the upper hand-written section (above the\n")
	file.WriteString("// beamsplitter marker comment).\n")
	file.WriteString("// ================================================================================================\n")
}
