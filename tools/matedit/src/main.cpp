...
static void printUsage(const char* name) {
    ...
    std::string usage(
        ...
        "\n"
        "           script input_shader_text_file output_file [<script args>...]\n"
        "\n"
        "       script should transform the shader located at input_shader_text_file into binary, writing\n"
        "       its results to output_file. The specifics of the binary format depend on the shader type:\n"
        "\n"
        "           metal: precompiled Metal library (.metallib)\n"
        "               The input file is guaranteed to have a .metal extension.\n"
        "               The output file is guaranteed to have a .metallib extension.\n"
        "\n"
