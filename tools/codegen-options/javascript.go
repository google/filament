...
func createCodeGenerator() *template.Template {
	...
	customExtensions := template.FuncMap{
		...
		"tstype": func(cpptype string) string {
			...
			// HACK: at this point, assume the type is a View-scoped enum
			return "View$" + strings.ReplaceAll(cpptype, "::", "$")
		},
	}
...
func EditTypeScript(definitions []Scope, folder string) {
	const MarkerCodeline = "The remainder of this file is generated by codegen-options"
	...
	var codelines []string
	{
		...
		for lineNumber := 1; lineScanner.Scan(); lineNumber++ {
			...
			if strings.Contains(codeline, MarkerCodeline) {
				foundMarker = true
				break
			}
	...
	file.WriteString("// " + MarkerCodeline + "\n")
