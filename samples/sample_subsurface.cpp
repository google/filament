...
static void printUsage(char* name) {
    ...
    std::string usage(
            "SAMPLE_SUBSURFACE is an example of subsurface rendering\n"
            "Usage:\n"
            "    SAMPLE_SUBSURFACE [options] <filamesh input files>\n"
            "Options:\n"
            "   --help, -h\n"
            "       Prints this message\n\n"
    ...
    const std::string from("SAMPLE_SUBSURFACE");
...
static void setup(Engine* engine, View* view, Scene* scene) {
    ...
    Texture* thickness = loadMap(engine, "thickness.png", false);

    if (!basecolor || !normal || !roughness) {
        std::cout << "Need basecolor.png, normal.png, roughness.png and thickness.png" << std::endl;
        return;
    }
    ...
    MaterialBuilder builder = MaterialBuilder()
            ...
            .parameter(MaterialBuilder::SamplerType::SAMPLER_2D, "thicknessMap")
            .material(R"SHADER(
                void material(inout MaterialInputs material) {
                    ...
                    material.baseColor.rgb = texture(materialParams_basecolorMap, uv).rgb;
                    material.roughness = texture(materialParams_roughnessMap, uv).r;
                    material.thickness = texture(materialParams_thicknessMap, uv).r;
                    material.subsurfaceColor.rgb = material.baseColor.rgb * vec3(0.46, 0.92, 0.71);
                }
            )SHADER")
    ...
    g_materialInstances["DefaultMaterial"]->setParameter("thicknessMap", thickness, sampler);
...
int main(int argc, char* argv[]) {
    ...
    g_config.title = "Subsurface shading";
