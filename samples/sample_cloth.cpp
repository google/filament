...
static int handleCommandLineArgments(int argc, char* argv[], Config* config) {
    ...
    static const utils::getopt::option OPTIONS[] = {
            ...
            { "api",            utils::getopt::required_argument, 0, 'a' },
            { "ibl",            utils::getopt::required_argument, 0, 'i' },
            { "split-view",     utils::getopt::no_argument,       0, 'v' },
            { "scale",          utils::getopt::required_argument, 0, 's' },
