...
std::unique_ptr<FilamentApp2> createSampleApp(SampleConfig config,
    ...
    auto setup = [app](Engine* engine, View* view, Scene* scene) {
        ...
        app->uvMorphTexture->setImage(*engine, 0, 0, 0, 0, width, height, 1,
                std::move(uvDeltaDesc));
        ...
        if (app->posMorphing) {
            ...
            app->mtb->setPositionsAt(*engine, 0, app->posMorphData.data(),
                    app->posMorphData.size());
        }
