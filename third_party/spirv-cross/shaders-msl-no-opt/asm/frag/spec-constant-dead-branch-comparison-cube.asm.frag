...
; Schema: 0
               ...
               OpName %ShadowMapCube "ShadowMapCube"
               ...
               OpDecorate %ShadowMapCube DescriptorSet 0
               OpDecorate %ShadowMapCube Binding 0
...
%type_sampled_image = OpTypeSampledImage %type_cube_image
  %ShadowMapCube = OpVariable %_ptr_UniformConstant_type_cube_image UniformConstant
...
%get_sampler_type = OpFunction %uint None %25
       ...
       %main = OpFunction %void None %21
         ...
         %37 = OpLabel
         %38 = OpLoad %type_cube_image %ShadowMapCube
         ...
         %41 = OpImageSampleDrefExplicitLod %float %40 %33 %float_0_5 Lod %float_0
               OpBranch %36
         %36 = OpLabel
         %42 = OpLoad %type_cube_image %ShadowMapCube
