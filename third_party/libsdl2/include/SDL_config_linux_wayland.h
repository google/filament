...
/* #undef SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC NULL"libwayland-client.so" */
/* #undef SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_EGL "libwayland-egl.so" */
/* #undef SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_CURSOR "libwayland-cursor.so" */
/* #undef SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_XKBCOMMON "libxkbcommon.so" */
