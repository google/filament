...
; Test that when a wavesize max is 0, preferred is also 0.
...
; CHECK: Function: node01: error: WaveSize Max (0) and Preferred (16) must be 0 to encode min==max
!10 = !{i32 16, i32 0, i32 16}
!11 = !{!"node01", i32 0}
