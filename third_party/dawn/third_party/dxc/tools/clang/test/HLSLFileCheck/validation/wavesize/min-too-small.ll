...
; (in this case, too small), a diagnostic is emitted
...
; CHECK: Function: node01: error: WaveSize Min (2) outside valid range [4..128], or not a power of 2.
!10 = !{i32 2, i32 64, i32 32}
!11 = !{!"node01", i32 0}
