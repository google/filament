...
; (in this case, not a power of 2), a diagnostic is emitted
...
; CHECK: Function: node01: error: WaveSize Preferred (15) outside valid range [4..128], or not a power of 2.
!10 = !{i32 16, i32 32, i32 15}
!11 = !{!"node01", i32 0}
