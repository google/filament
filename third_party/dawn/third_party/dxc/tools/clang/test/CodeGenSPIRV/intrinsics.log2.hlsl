...
// CHECK-NEXT: [[log2_g_row0:%[0-9]+]] = OpExtInst %v2float [[glsl]] Log2 [[g_row0]]
// CHECK-NEXT: [[g_row1:%[0-9]+]] = OpCompositeExtract %v2float [[g]] 1
// CHECK-NEXT: [[log2_g_row1:%[0-9]+]] = OpExtInst %v2float [[glsl]] Log2 [[g_row1]]
// CHECK-NEXT: [[g_row2:%[0-9]+]] = OpCompositeExtract %v2float [[g]] 2
// CHECK-NEXT: [[log2_g_row2:%[0-9]+]] = OpExtInst %v2float [[glsl]] Log2 [[g_row2]]
// CHECK-NEXT: [[log2_matrix:%[0-9]+]] = OpCompositeConstruct %mat3v2float [[log2_g_row0]] [[log2_g_row1]] [[log2_g_row2]]
