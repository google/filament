...
if0.exit:
  br i1 %c2, label %loop0.body1, label %loop0.body0

loop0.body0:
  ret i32 1

loop0.body1:
  br i1 %c1, label %loop0.body3, label %loop0.body2

loop0.body2:
  ret i32 2

loop0.body3:
  br i1 %c3, label %loop0.latch, label %loop0.exit
