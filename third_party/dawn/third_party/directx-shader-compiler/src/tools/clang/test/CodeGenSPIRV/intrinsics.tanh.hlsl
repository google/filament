...
// CHECK-NEXT: [[tanh_g_row0:%[0-9]+]] = OpExtInst %v2float [[glsl]] Tanh [[g_row0]]
// CHECK-NEXT: [[g_row1:%[0-9]+]] = OpCompositeExtract %v2float [[g]] 1
// CHECK-NEXT: [[tanh_g_row1:%[0-9]+]] = OpExtInst %v2float [[glsl]] Tanh [[g_row1]]
// CHECK-NEXT: [[g_row2:%[0-9]+]] = OpCompositeExtract %v2float [[g]] 2
// CHECK-NEXT: [[tanh_g_row2:%[0-9]+]] = OpExtInst %v2float [[glsl]] Tanh [[g_row2]]
// CHECK-NEXT: [[tanh_matrix:%[0-9]+]] = OpCompositeConstruct %mat3v2float [[tanh_g_row0]] [[tanh_g_row1]] [[tanh_g_row2]]
