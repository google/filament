...
; CHECK: Function: {{.*}}mainRG{{.*}}: error: Thread Group Shared Memory not supported from non-compute entry points.
...
!15 = !{void ()* @"\01?mainRG@@YAXXZ", !"\01?mainRG@@YAXXZ", null, null, !16}
