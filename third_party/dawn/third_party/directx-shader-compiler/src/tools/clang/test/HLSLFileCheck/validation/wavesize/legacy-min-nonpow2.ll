...
; arguments in the wavesize attribute for entry point functions.
; This test tests that when a wavesize argument is not valid
; (in this case, non-pow2), a diagnostic is emitted
...
; CHECK: Function: node01: error: WaveSize Min (5) outside valid range [4..128], or not a power of 2.
!10 = !{i32 5}
!11 = !{!"node01", i32 0}
