...
; CHECK: Function: {{.*}}mainCALL{{.*}}: error: Thread Group Shared Memory not supported from non-compute entry points.
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixLoadFromMemory
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixAccumulate not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixAccumulate
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixLength not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixLength
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgFillMatrix not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgFillMatrix
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixLength not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixLength
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixGetCoordinate not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixGetCoordinate
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixGetElement not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixGetElement
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixLoadFromMemory not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixLoadFromMemory
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixMultiply not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixMultiply
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixMultiplyAccumulate not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixMultiplyAccumulate
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixStoreToDescriptor not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixStoreToDescriptor
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixStoreToMemory not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixStoreToMemory
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgCopyConvertMatrix not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgCopyConvertMatrix
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Opcode LinAlgMatrixAccumulateToMemory not valid in shader model lib_6_10(callable).
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixAccumulateToMemory
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Entry function performs some operation that is incompatible with the shader stage or other entry properties.  See other errors for details.
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Function uses features incompatible with the shader stage (callable) of the entry function.
; CHECK-NEXT: Function: {{.*}}mainCALL{{.*}}: error: Function requires a visible group, but is called from a shader without one.
...
define void @"\01?mainCALL@@YAXUAttribs@@@Z"(%struct.Attribs* noalias nocapture %attrs) #0 {
