...
//CHECK-NEXT:        {{%[0-9]+}} = OpCompositeExtract %float [[query3]] 0
...
//CHECK-NEXT:        {{%[0-9]+}} = OpCompositeExtract %float [[query4]] 0
...
//CHECK-NEXT:        {{%[0-9]+}} = OpCompositeExtract %float [[query5]] 0
...
//CHECK-NEXT:        {{%[0-9]+}} = OpCompositeExtract %float [[query6]] 0
...
//CHECK-NEXT:        {{%[0-9]+}} = OpCompositeExtract %float [[query7]] 0
