...
// CHECK: [[sampled_result:%[a-zA-Z0-9_]+]] = OpImageSampleDrefImplicitLod %float [[tex1_load]] %float_0_5 %float_2 None
// CHECK: OpStore %val1 [[sampled_result]]
    float val1 = tex1d.SampleCmp(0.5, 2.0f);

// CHECK: [[tex2_load:%[a-zA-Z0-9_]+]] = OpLoad %type_sampled_image %tex1d
// CHECK: [[sampled_result_2:%[a-zA-Z0-9_]+]] = OpImageSampleDrefImplicitLod %float [[tex2_load]] %float_0_5 %float_2 ConstOffset %int_2
// CHECK: OpStore %val2 [[sampled_result_2]]
    float val2 = tex1d.SampleCmp(0.5, 2.0f, 2);

// CHECK: [[tex3_load:%[a-zA-Z0-9_]+]] = OpLoad %type_sampled_image %tex1d
// CHECK: [[sampled_result_3:%[a-zA-Z0-9_]+]] = OpImageSampleDrefImplicitLod %float [[tex3_load]] %float_0_5 %float_2 ConstOffset|MinLod %int_2 %float_0_5
// CHECK: OpStore %val3 [[sampled_result_3]]
    float val3 = tex1d.SampleCmp(0.5, 2.0f, 2, 0.5);
...
// CHECK: OpStore %val4 [[sampled_value]]
    ...
    uint status;
    float val4 = tex1d.SampleCmp(0.5, 2.0f, 2, 0.5, status);
