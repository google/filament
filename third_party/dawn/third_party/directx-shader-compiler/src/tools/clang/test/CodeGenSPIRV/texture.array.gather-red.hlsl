...
// CHECK:            [[t2u1:%[0-9]+]] = OpLoad %type_2d_image_array_0 %t2u1
...
// CHECK:            [[t2u1_0:%[0-9]+]] = OpLoad %type_2d_image_array_0 %t2u1
...
// CHECK-NEXT:                       OpStore %d [[res_2]]
    ...
    uint status;
// CHECK:              [[t2u1_1:%[0-9]+]] = OpLoad %type_2d_image_array_0 %t2u1
...
// CHECK:              [[t2u1_2:%[0-9]+]] = OpLoad %type_2d_image_array_0 %t2u1
...
// CHECK: [[gather:%[0-9]+]] = OpImageGather %v4float {{%[0-9]+}} {{%[0-9]+}} %int_0 Offset [[offset]]
// CHECK: [[texel0:%[0-9]+]] = OpCompositeExtract %float [[gather]] 0
// CHECK: [[gather_0:%[0-9]+]] = OpImageGather %v4float {{%[0-9]+}} {{%[0-9]+}} %int_0 Offset [[c34]]
// CHECK: [[texel1:%[0-9]+]] = OpCompositeExtract %float [[gather_0]] 1
// CHECK: [[gather_1:%[0-9]+]] = OpImageGather %v4float {{%[0-9]+}} {{%[0-9]+}} %int_0 Offset [[c56]]
// CHECK: [[texel2:%[0-9]+]] = OpCompositeExtract %float [[gather_1]] 2
// CHECK: [[offset_0:%[0-9]+]] = OpLoad %v2int %offset
// CHECK: [[gather_2:%[0-9]+]] = OpImageGather %v4float {{%[0-9]+}} {{%[0-9]+}} %int_0 Offset [[offset_0]]
