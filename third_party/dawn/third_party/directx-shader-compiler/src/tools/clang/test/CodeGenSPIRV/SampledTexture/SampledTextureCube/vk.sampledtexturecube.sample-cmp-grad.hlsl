...
// CHECK: [[a:%[a-zA-Z0-9_]+]] = OpImageSampleDrefExplicitLod %float [[tex0]] [[v3fc]] %float_0_25 Grad [[ddx_load]] [[ddy_load]]
  float a = tex.SampleCmpGrad(float3(0.5, 0.25, 0.75), 0.25f, ddx, ddy);
...
// CHECK: [[b:%[a-zA-Z0-9_]+]] = OpImageSampleDrefExplicitLod %float [[tex1]] [[v3fc]] %float_0_25 Grad|MinLod [[ddx_load_1]] [[ddy_load_1]] %float_0_5
  float b = tex.SampleCmpGrad(float3(0.5, 0.25, 0.75), 0.25f, ddx, ddy, 0.5f);
