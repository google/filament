...
// CHECK: OpStore %val [[val_red]]
    val = tex2darray.GatherCmpRed(float3(0.5, 0.25, 0.1), 0.5);
...
// CHECK: OpStore %val [[val_red_o]]
    val = tex2darray.GatherCmpRed(float3(0.5, 0.25, 0.1), 0.5, int2(2, 3));
...
// CHECK: OpStore %val [[val_red_o4]]
    val = tex2darray.GatherCmpRed(float3(0.5, 0.25, 0.1), 0.5, int2(1, 2), int2(3, 4), int2(5, 6), int2(7, 8));
