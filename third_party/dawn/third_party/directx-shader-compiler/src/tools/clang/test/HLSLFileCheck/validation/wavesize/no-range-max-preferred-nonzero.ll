...
; Test that when wavesize Min is zero, Max and Preferred is zero.
...
; CHECK: Function: node01: error: WaveSize Max (16) and Preferred (16) must be 0 when Min is 0
!10 = !{i32 0, i32 16, i32 16}
!11 = !{!"node01", i32 0}
