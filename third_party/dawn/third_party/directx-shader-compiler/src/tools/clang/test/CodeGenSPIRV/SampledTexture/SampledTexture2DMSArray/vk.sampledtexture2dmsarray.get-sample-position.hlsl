...
// CHECK:      [[tex_ms_array:%[0-9]+]] = OpLoad [[type_2d_sampled_image_ms_array]] %tex2dMSArray
// CHECK-NEXT: [[img_ms_array:%[0-9]+]] = OpImage [[type_2d_image_ms_array]] [[tex_ms_array]]
// CHECK-NEXT:[[count_ms:%[0-9]+]] = OpImageQuerySamples %uint [[img_ms_array]]
...
// CHECK-NEXT:   [[val_1:%[0-9]+]] = OpLoad %v2float %var_GetSamplePosition_result
// CHECK-NEXT:                  OpStore %posMSArray [[val_1]]
