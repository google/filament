...
; CHECK-NEXT: Function: mainMeS: error: Opcode LinAlgMatrixMultiply not valid in shader model ms_6_10.
...
define void @mainMeS() {
  ...
  call void @dx.op.storeVertexOutput.f32(i32 171, i32 0, i32 0, i8 2, float 0.000000e+00, i32 %3)  ; StoreVertexOutput(outputSigId,rowIndex,colIndex,value,vertexIndex)
  call void @dx.op.storeVertexOutput.f32(i32 171, i32 0, i32 0, i8 3, float 0.000000e+00, i32 %3)  ; StoreVertexOutput(outputSigId,rowIndex,colIndex,value,vertexIndex)
  ret void
}
...
!13 = !{[3 x i32] [i32 0, i32 4, i32 0]}
!14 = !{void ()* @mainMeS, !"mainMeS", !15, !8, !20}
!15 = !{null, !16, null}
!16 = !{!17}
