...
// CHECK: [[a:%[a-zA-Z0-9_]+]] = OpImageSampleDrefImplicitLod %float [[tex0]] [[v4fc]] %float_0_25 Bias %float_1
  float a = tex.SampleCmpBias(float4(0.5, 0.25, 0.75, 1.0), 0.25f, 1.0f);

// CHECK: [[tex1:%[a-zA-Z0-9_]+]] = OpLoad [[type_cube_array_sampled]] %tex
// CHECK: [[b:%[a-zA-Z0-9_]+]] = OpImageSampleDrefImplicitLod %float [[tex1]] [[v4fc]] %float_0_25 Bias|MinLod %float_1 %float_0_5
  float b = tex.SampleCmpBias(float4(0.5, 0.25, 0.75, 1.0), 0.25f, 1.0f, 0.5f);
