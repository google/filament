...
; CHECK: Function: mainHS: error: Thread Group Shared Memory not supported from non-compute entry points.
...
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixLoadFromMemory
; CHECK-NEXT: Function: mainHS: error: Opcode LinAlgMatrixMultiply not valid in shader model hs_6_10.
...
define void @mainHS() {
  ...
  %3 = call i32 @dx.op.outputControlPointID.i32(i32 107)  ; OutputControlPointID()
  ...
  %30 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 0, i32 %3)  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %31 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 1, i32 %3)  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %32 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 2, i32 %3)  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
  %33 = call float @dx.op.loadInput.f32(i32 4, i32 0, i32 0, i8 3, i32 %3)  ; LoadInput(inputSigId,rowIndex,colIndex,gsVertexAxis)
...
!13 = !{[11 x i32] [i32 4, i32 4, i32 1, i32 2, i32 4, i32 8, i32 20, i32 0, i32 0, i32 0, i32 6280]}
!14 = !{void ()* @mainHS, !"mainHS", !15, !8, !26}
!15 = !{!16, !16, !20}
!16 = !{!17}
...
!19 = !{i32 3, i32 15}
!20 = !{!21, !24, !25}
!21 = !{i32 0, !"SV_TessFactor", i8 9, i8 25, !22, i8 0, i32 3, i8 1, i32 0, i8 3, !23}
!22 = !{i32 0, i32 1, i32 2}
!23 = !{i32 3, i32 1}
