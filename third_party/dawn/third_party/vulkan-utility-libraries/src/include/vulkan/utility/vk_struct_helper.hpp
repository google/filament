...
template <> inline VkStructureType GetSType<VkPhysicalDeviceImageTilingControlFeaturesEXT>() { return VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_TILING_CONTROL_FEATURES_EXT; }
