...
void main() {
  ...
  c(f16mat4x3(v_1.inner_col0, v_1.inner_col1, v_1.inner_col2, v_1.inner_col3)[1u].x);
  c(f16mat4x3(v_1.inner_col0, v_1.inner_col1, v_1.inner_col2, v_1.inner_col3)[1u].zxy.x);
}
