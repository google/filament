...
static int i32_var1 = int(1);
static int i32_var2 = int(1);
static int i32_var3 = int(1);
...
static int3 v3i32_var1 = (int(1)).xxx;
static int3 v3i32_var2 = (int(1)).xxx;
static int3 v3i32_var3 = (int(1)).xxx;
...
void main() {
  ...
  v3i32_var1 = (int(0)).xxx;
  v3i32_var2 = (int(0)).xxx;
  v3i32_var3 = (int(0)).xxx;
  v3u32_var1 = (0u).xxx;
  v3u32_var2 = (0u).xxx;
  v3u32_var3 = (0u).xxx;
}
