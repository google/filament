...
public:
     ...
     * @return a CString containing the requested information. Can return empty string in cases
     *         where such query is not supported (for example on Vulkan without
     *         vkGetPhysicalDeviceProperties2).
     */
    virtual utils::CString getDeviceInfo(DeviceInfoType infoType,
            Driver* UTILS_NONNULL driver) const noexcept = 0;
