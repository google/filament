...
GLMemoryMappedBuffer::GLMemoryMappedBuffer(OpenGLState& gls, HandleAllocatorGL& handleAllocator,
...
#   if !defined(__EMSCRIPTEN__)
        ...
        gls.bindBuffer(bo->gl.binding, bo->gl.id);
...
void GLMemoryMappedBuffer::unmap(OpenGLState& gls, HandleAllocatorGL& handleAllocator) const {
    GLBufferObject* const bo = handleAllocator.handle_cast<GLBufferObject*>(boh);
    assert_invariant(bo);
...
void GLMemoryMappedBuffer::copy(OpenGLState& gls, OpenGLDriver& gld,
