...
UTILS_NOINLINE
const char* getGLError(const GLenum error) noexcept {
    switch (error) {
        case GL_NO_ERROR:
            return "GL_NO_ERROR";
...
UTILS_NOINLINE
GLenum checkGLError(io::ostream& out, const char *const function, const size_t line) noexcept {
    GLenum const error = glGetError();
    if (error != GL_NO_ERROR) {
        const char *const string = getGLError(error);
...
UTILS_NOINLINE
void assertGLError(io::ostream& out, const char *const function, const size_t line) noexcept {
...
UTILS_NOINLINE
const char* getFramebufferStatus(const GLenum status) noexcept {
    switch (status) {
...
UTILS_NOINLINE
GLenum checkFramebufferStatus(io::ostream& out, const GLenum target, const char *const function, const size_t line) noexcept {
...
UTILS_NOINLINE
void assertFramebufferStatus(io::ostream& out, const GLenum target, const char *const function, const size_t line) noexcept {
