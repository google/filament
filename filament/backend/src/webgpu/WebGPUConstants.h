...
constexpr size_t F_WEBGPU_BUFFER_SIZE_MODULUS = 4;
...
constexpr uint64_t F_WEBGPU_REQUEST_ADAPTER_TIMEOUT_NANOSECONDS =
        /* milliseconds */ 1000u * /* converted to ns */ 1000000u;

constexpr uint64_t F_WEBGPU_REQUEST_DEVICE_TIMEOUT_NANOSECONDS =
        /* milliseconds */ 1000u * /* converted to ns */ 1000000u;

constexpr uint64_t F_WEBGPU_SHADER_COMPILATION_TIMEOUT_NANOSECONDS =
        /* milliseconds */ 1000u * /* converted to ns */ 1000000u;
...
constexpr uint64_t F_WEBGPU_RENDER_PIPELINE_EXPIRATION_IN_FRAME_COUNT = 45;
...
constexpr uint64_t F_WEBGPU_PIPELINE_LAYOUT_EXPIRATION_IN_FRAME_COUNT = 90;
