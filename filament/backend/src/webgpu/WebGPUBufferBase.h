...
public:
    // Updates the GPU buffer with the data from the given BufferDescriptor.
...
protected:
    // Constructs the WebGPUBufferBase, creating a wgpu::Buffer with the specified usage and size.
