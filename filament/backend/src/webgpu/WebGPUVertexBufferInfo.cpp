 ...
 */
void createBufferLayoutsAndBindingSlots(AttributeArray const& attributes,
...
WebGPUVertexBufferInfo::WebGPUVertexBufferInfo(const uint8_t bufferCount,
    ...
    createBufferLayoutsAndBindingSlots(attributes, attributeCount, deviceLimits.maxVertexBuffers,
            mWebGPUSlotBindingInfos, mVertexBufferLayouts, attributeInfos);
