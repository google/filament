...
void WebGPUDriver::createVertexBufferR(Handle<HwVertexBuffer> vertexBufferHandle,
    ...
    constructHandle<WebGPUVertexBuffer>(vertexBufferHandle, mDevice, vertexCount,
...
void WebGPUDriver::updateBufferObject(Handle<HwBufferObject> ibh, BufferDescriptor&& p,
        uint32_t byteOffset) {
    handleCast<WebGPUBufferObject>(ibh)->updateGPUBuffer(p, byteOffset, mQueue);
...
void WebGPUDriver::setVertexBufferObject(Handle<HwVertexBuffer> vertexBufferHandle, uint32_t index,
