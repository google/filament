...
struct VulkanPlatformSwapChainImpl : public Platform::SwapChain {
  VulkanPlatformSwapChainImpl(VulkanContext const& context, VkDevice device,
                              VkQueue queue);
...
struct VulkanPlatformSurfaceSwapChain : public VulkanPlatformSwapChainImpl {
  VulkanPlatformSurfaceSwapChain(VulkanContext const& context,
...
struct VulkanPlatformHeadlessSwapChain : public VulkanPlatformSwapChainImpl {
  ...
  VulkanPlatformHeadlessSwapChain(VulkanContext const& context, VkDevice device,
                                  VkQueue queue, VkExtent2D extent,
                                  uint64_t flags);
