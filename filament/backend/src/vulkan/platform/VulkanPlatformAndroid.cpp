...
VulkanPlatform::ImageData VulkanPlatformAndroid::createVkImageFromExternal(
    ...
    auto buildImage = [&](ExternalImageMetadata const& metadata) {
        ...
        VkImageCreateInfo const imageInfo{
            ...
            .flags = isExternal? VK_IMAGE_CREATE_ALIAS_BIT : 0u,
            .imageType = VK_IMAGE_TYPE_2D,
            .format = isExternal? VK_FORMAT_UNDEFINED : metadata.format,
            .extent = {
                metadata.width,
                metadata.height,
                1u,
            ...
            .usage = isExternal ? VK_IMAGE_USAGE_SAMPLED_BIT : metadata.usage,
        };
        VkImage image;
