...
void VulkanDriver::draw(PipelineState pipelineState, Handle<HwRenderPrimitive> rph,
    ...
    vkraster.colorBlendOp = (VkBlendOp) rasterState.blendEquationRGB;
    ...
    vkraster.alphaBlendOp =  (VkBlendOp) rasterState.blendEquationAlpha;
    ...
    vkraster.depthCompareOp = getCompareOp(rasterState.depthFunc);
