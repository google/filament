...
template<typename T>
void erasep(std::vector<T>& v, std::function<bool(T const&)> predicate) {
...
void VulkanExternalImageManager::bindExternalImage(fvkmemory::resource_ptr<VulkanDescriptorSet> set,
...
void VulkanExternalImageManager::addExternalImageTexture(
...
void VulkanExternalImageManager::removeExternalImageTexture(
        fvkmemory::resource_ptr<VulkanTexture> image) {
    erasep<SetBindingInfo>(mSetBindings,
...
bool VulkanExternalImageManager::isExternalImageTexture(
