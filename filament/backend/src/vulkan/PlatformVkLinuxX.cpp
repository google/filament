...
Driver* PlatformVkLinuxX::createDriver(void* const sharedContext) noexcept {
...
void* PlatformVkLinuxX::createVkSurfaceKHR(void* nativeWindow, void* instance, uint64_t flags) noexcept {
