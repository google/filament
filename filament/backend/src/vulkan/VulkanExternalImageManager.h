...
public:
    ...
    void bindExternalImage(fvkmemory::resource_ptr<VulkanDescriptorSet> set, uint8_t bindingPoint,
            fvkmemory::resource_ptr<VulkanTexture> image, SamplerParams samplerParams);

    void addExternalImageTexture(fvkmemory::resource_ptr<VulkanTexture> image,
            Platform::ExternalImageHandleRef platformHandleRef);

    void removeExternalImageTexture(fvkmemory::resource_ptr<VulkanTexture> image);

    bool isExternalImageTexture(fvkmemory::resource_ptr<VulkanTexture> image) const;
