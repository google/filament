...
public:
    ...
    // Initialize with the same spec constants/programs owned by the given material. Called by
    // MaterialInstance.
    void initializeFromMaterial(FEngine& engine, FMaterial const& material);

    bool isInitialized() { return mMaterial != nullptr; }
