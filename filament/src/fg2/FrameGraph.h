...
public:
     ...
     * @param desc      Descriptor for the imported FrameGraphRenderPass
     * @param target    handle to the concrete FrameGraphRenderPass to import
     * @return          A handle to a FrameGraphTexture
     */
    FrameGraphId<FrameGraphTexture> import(const char* name, FrameGraphRenderPass::Descriptor const& desc,
