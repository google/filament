...
Engine* FEngine::create(Builder const& builder) {
    ...
    if constexpr (!UTILS_HAS_THREADING) {
        ...
        DriverConfig const driverConfig{
                ...
                .disableAmortizedShaderCompile = instance->features.backend.disable_amortized_shader_compile,
...
int FEngine::loop() {
    ...
    DriverConfig const driverConfig {
            ...
            .disableAmortizedShaderCompile = features.backend.disable_amortized_shader_compile,
