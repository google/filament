 ...
 */
class CameraHelper(val activity: Activity, private val filamentEngine: Engine, private val filamentTexture: Texture,
                   private val textureTransform: FloatArray) {
    ...
    private var resolution = Size(400, 400)
    ...
    fun pushExternalImageToFilament() {
        Log.e("filament", "++++++++++++++++++push external image to filament")
        imageReader.acquireLatestImage()?.also {
            Log.e("filament", "++++++++++++++++++acquiring")
            val mainHandler = Handler(Looper.getMainLooper())
            mainHandler.post {
                Log.e("filament", "++++++++++++++++++posted?")
                ExternalImage.setOnTexture(filamentEngine, filamentTexture, it.hardwareBuffer!!, false)
                it.close()
            }
        }
    }
    ...
    private fun createCaptureSession() {
        Log.e("filament", "++++++++++++++++++capture session");
...
//        val textureTransform = FloatArray(16)
    ...
    companion object {
        private const val kLogTag = "filament"
