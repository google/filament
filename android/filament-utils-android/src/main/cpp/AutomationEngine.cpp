...
Java_com_google_android_filament_utils_AutomationEngine_nCreateAutomationEngine(JNIEnv* env, jclass,
        jstring spec_) {
    return filament::android::jniGuard<jlong>(env, "Java_com_google_android_filament_utils_AutomationEngine_nCreateAutomationEngine", 0, [&]() -> jlong {
...
Java_com_google_android_filament_utils_AutomationEngine_nCreateDefaultAutomationEngine(JNIEnv* env,
        jclass klass) {
    return filament::android::jniGuard<jlong>(env, "Java_com_google_android_filament_utils_AutomationEngine_nCreateDefaultAutomationEngine", 0, [&]() -> jlong {
...
Java_com_google_android_filament_utils_AutomationEngine_nSetOptions(JNIEnv* env, jclass klass,
    ...
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nSetOptions", [&]() {
...
Java_com_google_android_filament_utils_AutomationEngine_nStartRunning(JNIEnv* env, jclass klass,
    ...
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nStartRunning", [&]() {
            AutomationEngine* automation = (AutomationEngine*) nativeAutomation;
...
Java_com_google_android_filament_utils_AutomationEngine_nStartBatchMode(JNIEnv* env, jclass klass,
        jlong nativeAutomation) {
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nStartBatchMode", [&]() {
            AutomationEngine* automation = (AutomationEngine*) nativeAutomation;
...
Java_com_google_android_filament_utils_AutomationEngine_nTick(JNIEnv* env, jclass klass,
    ...
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nTick", [&]() {
...
Java_com_google_android_filament_utils_AutomationEngine_nApplySettings(JNIEnv* env, jclass klass,
    ...
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nApplySettings", [&]() {
            using MaterialPointer = MaterialInstance*;
...
Java_com_google_android_filament_utils_AutomationEngine_nGetViewerOptions(JNIEnv* env, jclass,
    ...
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nGetViewerOptions", [&]() {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_google_android_filament_utils_AutomationEngine_nGetColorGrading(JNIEnv* env, jclass,
        jlong nativeObject, jlong nativeEngine) {
    return filament::android::jniGuard<jlong>(env, "Java_com_google_android_filament_utils_AutomationEngine_nGetColorGrading", 0, [&]() -> jlong {
            AutomationEngine* automation = (AutomationEngine*) nativeObject;
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_android_filament_utils_AutomationEngine_nSignalBatchMode(JNIEnv* env, jclass, jlong native) {
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nSignalBatchMode", [&]() {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_android_filament_utils_AutomationEngine_nStopRunning(JNIEnv* env, jclass, jlong native) {
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nStopRunning", [&]() {
            AutomationEngine* automation = (AutomationEngine*) native;
...
Java_com_google_android_filament_utils_AutomationEngine_nShouldClose(JNIEnv* env, jclass, jlong native) {
    return filament::android::jniGuard<jboolean>(env, "Java_com_google_android_filament_utils_AutomationEngine_nShouldClose", JNI_FALSE, [&]() -> jboolean {
            AutomationEngine* automation = (AutomationEngine*) native;
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_android_filament_utils_AutomationEngine_nDestroy(JNIEnv* env, jclass, jlong native) {
    filament::android::jniGuardVoid(env, "Java_com_google_android_filament_utils_AutomationEngine_nDestroy", [&]() {
            AutomationEngine* automation = (AutomationEngine*) native;
            delete automation;
    });
}
