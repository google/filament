...
public class IndirectLight {
    ...
    public static class Builder {
         ...
         * <p></p>
         * The irradiance must be pre-convolved by <code>&lt n &sdot l &gt</code> and
         ...
         * reconstruction factors A<sub>l</sub><sup>m</sup>.
         * <p></p>
         * The final coefficients can be generated using the <code>cmgen</code> tool.
         * <p></p>
         * The index in the <code>sh</code> array is given by:
         * <p>
         *  <code>index(l, m) = l * (l + 1) + m</code>
         * <p>
         *  <code>sh[index(l,m)] = L<sub>l</sub><sup>m</sup>
         *                      &times 1/&pi
         *                      &times A<sub>l</sub><sup>m</sup>
         *                      &times C<sub>l</sub> </code>
         * <p>
         *
         * <center>
         * <table border="1" cellpadding="3">
         *     <tr><th> index </th><th> l </th><th> m </th><th> A<sub>l</sub><sup>m</sup> </th><th> C<sub>l</sub> </th>
         *                  <th> 1/&pi &times A<sub>l</sub><sup>m</sup> &times C<sub>l</sub></th></tr>
         ...
         * <p>
         * Because the coefficients are pre-scaled, <code>sh[0]</code> is the environment's
         * average irradiance.
         * <p>
         ...
         *                  The size of the array must be <code>bands<sup>2</sup></code>
         ...
         * <p></p>
         * The radiance must be specified as Spherical Harmonics coefficients L<sub>l</sub><sup>m</sup>
         * <p></p>
         * The index in the <code>sh</code> array is given by:
         * <p>
         *  <code>index(l, m) = l * (l + 1) + m</code>
         * <p>
         *  <code>sh[index(l,m)] = L<sub>l</sub><sup>m</sup></code>
         * <p></p>
         *
         * <center>
         * <table border="1" cellpadding="3">
