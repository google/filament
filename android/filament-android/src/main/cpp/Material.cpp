...
Java_com_google_android_filament_Material_nBuilderBuild(JNIEnv *env, jclass,
        jlong nativeEngine, jobject buffer_, jint size, jint shBandCount, jint shadowQuality, jboolean disableUboBatching) {
    ...
    builder.disableUboBatching(disableUboBatching);
