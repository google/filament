...
// to JavaScript as "driver$BufferDescriptor", but clients will normally use our
// "Filament.BufferDescriptor" helper function, which is implemented in wasmloader.
