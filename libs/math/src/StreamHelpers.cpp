...
template std::ostream& printMatrix(std::ostream& stream, const double* data, size_t rows, size_t cols);
template std::ostream& printMatrix(std::ostream& stream, const float* data, size_t rows, size_t cols);
