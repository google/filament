...
BufferInterfaceBlock const& UibGenerator::getPerViewUib() noexcept  {
    ...
    static BufferInterfaceBlock const uib = BufferInterfaceBlock::Builder()
            ...
            // AO
            { "aoSamplingQualityAndEdgeDistance", 0, Type::FLOAT,  Precision::DEFAULT, FeatureLevel::FEATURE_LEVEL_0 },
            { "aoBentNormals",          0, Type::FLOAT,  Precision::DEFAULT, FeatureLevel::FEATURE_LEVEL_0 },
