...
public:
     ...
     */
    MaterialBuilder& coloredPenumbra(bool coloredPenumbra) noexcept;
...
template<>
struct utils::EnableBitMaskOperators<filamat::MaterialBuilder::TargetApi> : std::true_type {
};

template<>
struct utils::EnableBitMaskOperators<filamat::MaterialBuilder::Workarounds> : std::true_type {
};
